...
### Crea la fecha con el formato de datetime. Devuelve False si el formato es erróneo
```
def set_fecha(fecha):
    try:
...
def formatear_fecha(fecha):
    ...
    return fecha_formateada
```
### Permite añadir nuevas tareas a la lista con el formato: Nombre, prioridad, fecha
```
def add_tarea():
    ...
    if len(lista_tareas) == 0:
        ...
        for tarea in lista_tareas:
            ...
            print(f"""
                ...
                """)
```
### Elimina tareas en función del ID introducido
```
def eliminar_tarea():
